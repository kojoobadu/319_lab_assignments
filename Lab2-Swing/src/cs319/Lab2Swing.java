			...
			new DefaultMutableTreeNode("Aminals") {
				{
					...
					Animal = new DefaultMutableTreeNode("Mammals");
						Animal.add(new DefaultMutableTreeNode("Human"));
					add(Animal);
					Animal = new DefaultMutableTreeNode("Reptiles");
						Animal.add(new DefaultMutableTreeNode("Lizard"));
					add(Animal);
					Animal = new DefaultMutableTreeNode("Birds");
						Animal.add(new DefaultMutableTreeNode("Duck"));
					add(Animal);
					Animal = new DefaultMutableTreeNode("Insects");
						Animal.add(new DefaultMutableTreeNode("Ant"));
					add(Animal);
					Animal = new DefaultMutableTreeNode("Fish");
						Animal.add(new DefaultMutableTreeNode("Shark"));
					add(Animal);
				}
			}
		));
